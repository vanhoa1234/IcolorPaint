...
#define JPSThumbnailAnnotationViewStandardWidth     105.0f
#define JPSThumbnailAnnotationViewStandardHeight    130.0f//87.0f
#define JPSThumbnailAnnotationViewExpandOffset      180.0f
...
- (id)initWithAnnotation:(id<MKAnnotation>)annotation {
    ...
    if (self) {
        ...
        // Image View
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(12.5, 12, 80, 80)];
        ...
        // Name Label
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 15, 168, 40)];
        ...
        // Distance Label
        _subtitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 60, 168, 20)];
