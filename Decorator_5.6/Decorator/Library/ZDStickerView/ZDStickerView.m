...
@synthesize preventsResizeWhenRotating;
/*
            ...
            if (self.bounds.size.width < minWidth || self.bounds.size.height < minHeight)
            {
                ...
                resizingControl.frame =CGRectMake(self.bounds.size.width-kZDStickerViewControlSize,
                                           self.bounds.size.height-kZDStickerViewControlSize,
                                                  ...
                                                  kZDStickerViewControlSize);
                deleteControl.frame = CGRectMake(self.bounds.size.width-kZDStickerViewControlSize,0,kZDStickerViewControlSize,kZDStickerViewControlSize);
                customControl.frame = CGRectMake(0, 0,kZDStickerViewControlSize, kZDStickerViewControlSize);
                prevPoint = [recognizer locationInView:self];
...
//            self.transform = CGAffineTransformIdentity;
    ...
    {
        prevPoint = [recognizer locationInView:self];
        [_delegate stickerViewDidPan:self];
        [self setNeedsDisplay];
    }
}
...
- (void)setupDefaultAttributes {
...
#endif                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
    deleteControl = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width-kZDStickerViewControlSize,0,kZDStickerViewControlSize, kZDStickerViewControlSize)];//[[UIImageView alloc]initWithFrame:CGRectMake(0, 0,kZDStickerViewControlSize, kZDStickerViewControlSize)];
    ...
    resizingControl.image = [UIImage imageNamed:@"rotate.png" ];
    ...
    customControl = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0,kZDStickerViewControlSize, kZDStickerViewControlSize)];//[[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width-kZDStickerViewControlSize,0,kZDStickerViewControlSize, kZDStickerViewControlSize)];
...
- (void)setFrame:(CGRect)newFrame {
    ...
    resizingControl.frame =CGRectMake(self.bounds.size.width-kZDStickerViewControlSize,
                                      ...
                                      kZDStickerViewControlSize,
                                      kZDStickerViewControlSize);
    deleteControl.frame = CGRectMake(self.bounds.size.width-kZDStickerViewControlSize,0,kZDStickerViewControlSize,kZDStickerViewControlSize);//CGRectMake(0, 0,kZDStickerViewControlSize, kZDStickerViewControlSize);
    customControl.frame = CGRectMake(0, 0,kZDStickerViewControlSize, kZDStickerViewControlSize);//CGRectMake(self.bounds.size.width-kZDStickerViewControlSize,0,kZDStickerViewControlSize,kZDStickerViewControlSize);
    [borderView setNeedsDisplay];
}
