...
//    UIBezierPath *roundedPath = [UIBezierPath bezierPathWithRoundedRect:contentRect cornerRadius:17.0f];
//    CGContextSetFillColorWithColor(ref, [UIColor blackColor].CGColor);
//    CGContextSetShadowWithColor(ref, CGSizeMake(0.0, 0.0), 5, [UIColor blackColor].CGColor);
//    [roundedPath fill];
//    
