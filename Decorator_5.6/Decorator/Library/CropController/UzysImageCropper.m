...
- (id)initWithImage:(UIImage*)newImage andframeSize:(CGSize)frameSize andcropSize:(CGSize)cropSize
{
    ...
    if(self)
    {
        ...
        _cropperView.layer.borderColor = [UIColor greenColor].CGColor;
        _cropperView.layer.borderWidth = 5.0f;
        _cropperView.layer.shadowColor = [UIColor blackColor].CGColor;
        _cropperView.layer.shadowOpacity = 0.7f;
        _cropperView.layer.shadowOffset = CGSizeMake(0.0f, 5.0f);
        _cropperView.layer.masksToBounds = NO;
        _cropperView.alpha = 0.7;
