...
public:
    ...
    void setTransparent(const int transparent);
    // get transparen color
    int getTransparent();
...
private:
    ...
    //
    void compressDynamicToReference(const cv::Mat &ref, cv::Mat &dest, const cv::Mat &mask);
    //
